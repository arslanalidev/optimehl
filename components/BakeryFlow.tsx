...
const calculateX = (quarter: number) => quarter * QUARTER_HOUR_WIDTH;
...
const unoptimizedNodes = [
  ...
  {
    id: 'm1_task1',
    position: { x: calculateX(12), y: 80 },
    data: { label: 'Brezel' }
  },
  {
    id: 'm1_task2',
    position: { x: calculateX(24), y: 80 },
    data: { label: 'Körnerbrötchen' }
  },
  { id: 'm2', position: { x: 0, y: 180 }, data: { label: 'Mitarbeiter 2' } },
  {
    id: 'm2_task1',
    position: { x: calculateX(8), y: 180 },
    data: { label: 'Mürbeteigboden' }
  },
  {
    id: 'm2_task2',
    position: { x: calculateX(28), y: 180 },
    data: { label: 'Brezel' }
  }
];
...
const optimizedNodes = [
  {
    id: 'm1_opt',
    position: { x: 0, y: 280 },
    data: { label: 'Mitarbeiter 1' }
  },
  {
    id: 'm1_opt_task1',
    position: { x: calculateX(4), y: 280 },
    style: yellowBgStyle,
    data: { label: 'Brezel' }
  },
  {
    id: 'm1_opt_task2',
    position: { x: calculateX(8), y: 280 },
    style: yellowBgStyle,
    data: { label: 'Körnerbrötchen' }
  },
  {
    id: 'm2_opt',
    position: { x: 0, y: 380 },
    data: { label: 'Mitarbeiter 2' }
  },
  {
    id: 'm2_opt_task1',
    position: { x: calculateX(12), y: 380 },
    style: yellowBgStyle,
    data: { label: 'Mürbeteigboden' }
  },
  {
    id: 'm2_opt_task2',
    position: { x: calculateX(16), y: 380 },
    style: yellowBgStyle,
    data: { label: 'Brezel' }
  }
];
